-- SQLite dialect of migrations/postgres/003_mqtt_credentials.sql.
...
CREATE TABLE IF NOT EXISTS mqtt_credentials (
  ...
  acl_denial_count   INTEGER NOT NULL DEFAULT 0,
...
ALTER TABLE gateways ADD COLUMN lifecycle_state TEXT NOT NULL DEFAULT 'provisioned';
ALTER TABLE gateways ADD COLUMN commissioned_at TEXT;
ALTER TABLE gateways ADD COLUMN decommissioned_at TEXT;
...
ALTER TABLE gateways ADD COLUMN replaced_by_gateway_id TEXT;
ALTER TABLE gateways ADD COLUMN environment TEXT NOT NULL DEFAULT 'production';
